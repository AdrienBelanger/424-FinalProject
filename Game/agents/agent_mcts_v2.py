...
class agent_mcts(Agent):
  ...
  def step(self, chess_board, player, opponent):
    ...
    print(f"Final move exploit values: {exploit[0]}")
    print(f"Final move explorations: {explore[0]}")
    print(f"Final move scores: {compute_move_scores(exploit[0],explore[0],1,Q,K)}")
